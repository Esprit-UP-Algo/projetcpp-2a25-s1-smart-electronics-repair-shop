...
private slots:
    ...
    void onMontantTotalCalcule(double montant);
...
private:
    ...
    QString currentMarque = "";
    QTimer *financeTimer = nullptr;

    void startFinanceAnimation(double valeurPerdue, const QString& marque);
    void animateFinance();
};
#endif // MAINWINDOW_H
